...
👉 Val_dec_2025_Binance.csvUtiliser un autre historiqueIl est possible de charger un autre fichier d'historique directement  
 depuis l'interface Streamlit pour analyser d'autres périodes.  
