...
**Construction de l'image :** Bashdocker build -t btc-dashboard .
**Lancement  du dashboard :** Bashdocker run -p 8501:8501 btc-dashboard
...
**package tree**
.
├── BTC_dashboard.py      # Script principal Streamlit
